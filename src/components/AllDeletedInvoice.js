...
const AllDeletedInvoice = ({ dbpath }) => {
    ...
    const loadData = async () => {
        try {
            const response = await axios.get(dbpath + "displayDeletedInvoice.php");
...
export default AllDeletedInvoice;
